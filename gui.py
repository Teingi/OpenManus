...
class ColoredTextEdit(QTextEdit):
    def __init__(self, parent=None):
        ...
        self.setFont(QFont("Microsoft YaHei", 12))  # 使用支持中文的字体
...
class ManusGUI(QMainWindow):
    ...
    def initUI(self):
        # Main window setup
        self.setWindowTitle('obdiag AI Assistant')
        ...
        title_label = QLabel("obdiag AI Assistant")
        ...
        self.output_display.append_colored_text("Welcome to obdiag AI Assistant!", "info")
