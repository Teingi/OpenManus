...
connection_args = {
    ...
    "user": os.getenv("DB_USER") or "root@test",
...
embeddings = get_embedding(
    ...
    base_url=os.getenv("OPENAI_EMBEDDING_BASE_URL") or "",
    api_key=os.getenv("OPENAI_EMBEDDING_API_KEY") or os.getenv("API_KEY"),
    model=OBragSettings.model_type or "deepseek-v3",
)
...
def doc_rag_stream(
    ...
    **kwargs,
    ...
    """
    print("doc_rag_stream", query, chat_history, llm_model, suffixes, universal_rag, rerank, search_docs, lang, show_refs)
